...
type AuthContextValue = {
  ...
  signUp: (email: string, password: string, data?: UniversalSignupData) => Promise<{ error: string | null; userId: string | null; hasSession: boolean }>;
...
export function AuthProvider({children}:{children:React.ReactNode}) {
 ...
 return <AuthContext.Provider value={{session,user:session?.user??null,profile,loading,error:error??configError,refreshProfile,signUp,signIn,signOut}}>{children}</AuthContext.Provider>;
}
