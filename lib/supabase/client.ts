...
export type SupabaseBrowserClient = SupabaseClient<Database, "public", Database["public"]>;
...
export function getSupabaseBrowserClient(): SupabaseBrowserClient {
  ...
  browserClient = createClient<Database, "public", Database["public"]>(url, anonKey, {
