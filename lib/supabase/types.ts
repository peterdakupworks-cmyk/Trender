...
export type Database = {
  public: {
    Tables: {
      ...
      creator_presence: {
        Row: { creator_id: string; last_seen_at: string };
        Insert: { creator_id: string; last_seen_at?: string };
        Update: { creator_id?: string; last_seen_at?: string };
        Relationships: [];
      };
    };
